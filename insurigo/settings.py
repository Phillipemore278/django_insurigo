"""
Django settings for insurigo project.
...
SECRET_KEY = 'django-insecure-t763sjld@4xn(sv=1)6l#(h+xd9ld&jm6-i%497%f6-kg4g-s!'
...
WSGI_APPLICATION = 'insurigo.wsgi.application'
